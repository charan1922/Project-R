            ...
            <li key={item.id}>
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {activeSymbol === item.symbol && <RefreshCw className="w-3 h-3 animate-spin text-rose-400" />}
                </div>
              </button>
            </li>
          ))
        ...
        {filteredFno.map((symbol) => (
          <li key={`fno-${symbol}`}>
            ...
            >
              <div className="flex justify-between items-center">
                <span>{symbol}</span>
                {activeSymbol === symbol && <RefreshCw className="w-3 h-3 animate-spin text-sky-400" />}
              </div>
            </button>
          </li>
        ))}

...
import { Building2, TrendingUp, Search, BarChart3, ArrowUpRight, ArrowDownRight } from "lucide-react";
          ...
          <CardContent className="p-4">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <select
                ...
                className="px-4 py-2 rounded-md bg-slate-900 border border-slate-700 text-white"
              >
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {stocks.slice(0, 10).map((stock) => (
                <div
                  key={stock.symbol}
                  className="p-3 rounded-lg bg-slate-900/50 border border-slate-700 hover:border-emerald-500/50 transition-colors"
                >
        ...
        <div className="space-y-6">
          {Object.entries(groupedBySector)
            ...
            .map(([sector, sectorStocks]) => (
              <Card key={sector} className="bg-slate-800/50 border-slate-700">

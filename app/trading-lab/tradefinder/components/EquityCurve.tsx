...
export function EquityCurve({ data: { equity } }: Props) {
  return (
    <Section title="12. Equity Curve (Cumulative P&L)" icon={TrendingUp} color="text-emerald-400">
      <div className="mt-2 h-72">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={equity} margin={{ top: 5, right: 10, bottom: 0, left: 10 }}>
            ...
            />
            <Area type="monotone" dataKey="pnl" stroke="#34d399" strokeWidth={2} fill="url(#pnlGrad)" dot={false} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </Section>

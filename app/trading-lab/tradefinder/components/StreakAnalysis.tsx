...
export function StreakAnalysis({ data: { wins, losses, maxWin, maxLoss, sorted } }: Props) {
  ...
  return (
    <Section title="10. Streak Analysis" icon={Flame} color="text-orange-400">
      ...
      <div className="mt-5">
        <p className="text-xs text-slate-500 uppercase font-semibold mb-2">Trade-by-Trade P&L Sequence (last 60)</p>
        <div className="h-48">

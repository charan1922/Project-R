...
import { Activity, BarChart2, Clock, Database, Download, HardDrive, List, Search, Upload } from 'lucide-react';
      ...
      >
        <div className="w-full max-w-xl bg-slate-900 border border-slate-800 rounded-xl shadow-2xl overflow-hidden cmdk-dialog">
          ...
          <Command.List className="max-h-[300px] overflow-y-auto overflow-x-hidden p-2 custom-scrollbar">
            ...
            <Command.Group heading="Historify Quick Links" className="text-xs font-medium text-slate-500 px-2 py-1.5">
              <Command.Item
              ...
              <Command.Item
                onSelect={() => runCommand(() => router.push('/historify/watchlist'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >
              ...
              <Command.Item
                onSelect={() => runCommand(() => router.push('/historify/charts'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >
              ...
              <Command.Item
                onSelect={() => runCommand(() => router.push('/historify/import'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >
              ...
              <Command.Item
                onSelect={() => runCommand(() => router.push('/historify/download'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >
              ...
              <Command.Item
                onSelect={() => runCommand(() => router.push('/historify/export'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >
              ...
              <Command.Item
                onSelect={() => runCommand(() => router.push('/historify/scheduler'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >
            ...
            >
              <Command.Item
                onSelect={() => runCommand(() => router.push('/trading-lab/fno-universe'))}
                className="flex cursor-pointer select-none items-center rounded-md px-2 py-2.5 text-sm text-slate-300 hover:bg-slate-800 hover:text-white aria-selected:bg-slate-800 aria-selected:text-white transition-colors"
              >

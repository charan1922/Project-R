...
import type { AlertOrderRequest, AlertModifyRequest, AlertOrderResponse, GetAlertResponse } from '../types';
...
export class AlertsApi {
   ...
   */
  async createAlertOrder(req: Omit<AlertOrderRequest, 'dhanClientId'>): Promise<AlertOrderResponse> {
